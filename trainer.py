...
from processors.ner_span_for_C import convert_examples_to_features        # 修改这里。 processors.ner_span_for_C/D/P
...
def dewordpiece(args):
    with open(args.output_dir + "/test_predict.json", "r+") as f:
        data = f.readlines()
    # print(args.output_dir + "/test_predict.json")
    bert_pred_list = []
    ...
    # print('gs_label_list:',gs_label_list)
